                        ...
                        {isPending ? (
                            ...
                            MemoNotify.map((item: IMemoNotify, idx: number) => (
                                <tr key={idx} className="pl-0 pt-0 memo-row bg-white border dark:bg-[#1e1e1e69]">
                                    ...
                                    <td data-label="Bộ phận áp dụng" className="border text-black px-4 py-4 break-words whitespace-normal dark:text-white">{item.applyAllDepartment ? "Tất cả phòng ban" : item?.departmentNames ?? "---"}</td>
                                    ...
                                    <td data-label="Trạng thái"
                                        className={`text-black border px-4 py-4 font-bold dark:text-white`}>
