...
import overTimeApi, { useHrNoteOverTime, useRejectSomeOverTime } from "@/api/overTimeApi"
            ...
            <div className="flex flex-wrap justify-between items-center gap-y-2 gap-x-4 mb-1">
                <h3 className="font-bold text-xl md:text-2xl m-0 pb-2">{lang == 'vi' ? 'Duyệt tăng ca' : 'Approval overtime'}</h3>
                {
                    isHrAndHRPermissionMngLeaverqAndLeaveIsWaitHR && (
                        ...
                        >
                            {hrExportExcelLeaveRequest.isPending ? <Spinner className="text-white" size="small"/> : 'Export excel'}
                        </Button>
                    )
                }
            </div>
                        ...
                        isHrAndHRPermissionMngLeaverqAndLeaveIsWaitHR ? (
                            ...
                            <>
                                ...
                                <Button
                                    ...
                                    disabled={rejectSomeOverTime.isPending || approval.isPending}
