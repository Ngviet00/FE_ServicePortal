    ...
    return (
        <div className="p-1 pl-1 pt-0 space-y-4">
            <div className="flex flex-wrap justify-between items-center gap-y-2 gap-x-4 mb-1">
                <h3 className="font-bold text-xl md:text-2xl m-0">Thống kê</h3>
            </div>

            <div className='mt-2'>
                <label className="block mb-2 font-semibold text-sm text-gray-700">Thời gian:</label>
                <DateRangePicker
                    key="1"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="bg-[#efefef] p-6 rounded-lg shadow-inner flex flex-col items-center text-center border">
                    ...
                    <h3 className="text-gray-600 mb-2">Tổng Yêu Cầu</h3>
                ...
                <div className="bg-[#efefef] p-6 rounded-lg shadow-inner flex flex-col items-center text-center border">
                    ...
                    <h3 className="text-gray-600 mb-2">Đang xử lý</h3>
                ...
                <div className="bg-[#efefef] p-6 rounded-lg shadow-inner flex flex-col items-center text-center border">
                    ...
                    <h3 className="text-gray-600 mb-2">Đã hoàn thành</h3>
                ...
                <div className="bg-[#efefef] p-6 rounded-lg shadow-inner flex flex-col items-center text-center border">
                    ...
                    <h3 className="text-gray-600 mb-2">Đang chờ duyệt</h3>
            ...
            <div className="flex w-full gap-x-10 mb-0">
                <div className="flex-1 flex flex-col items-center bg-[#efefef] p-3 rounded-lg shadow-inner border">
                    <div className='w-full flex justify-between'>
                        <h2 className="mb-5 font-semibold text-lg">Tổng số lượng yêu cầu</h2>
                        <div>
                            <SelectOptionChart/>
                        </div>
                    </div>
                ...
                <div className="flex-1 flex flex-col items-center bg-[#efefef] p-3 rounded-lg shadow-inner border">
                    <div className='w-full flex justify-between'>
                        <h2 className="mb-5 font-semibold text-lg">Tổng yêu cầu theo loại</h2>
                        <div>
                            <SelectOptionChart/>
                        </div>
                    </div>
            ...
            <div className='mt-8'>
                <div className="flex-1 flex flex-col items-center bg-[#efefef] p-3 rounded-lg shadow-inner border">
                    <div className='w-full flex justify-start'>
                        <h2 className="mb-5 font-semibold text-lg mr-5">Tổng yêu cầu theo phòng ban</h2>
                        <div>
                            <SelectOptionChart/>
                        </div>
                    </div>
            ...
            <div className="bg-[#efefef] p-6 mb-8 pt-2 mt-8 rounded-lg shadow-inner border">
                <h3 className="text-xl font-semibold mb-4 border-b pb-2 border-gray-600">Yêu Cầu Gần Đây</h3>
