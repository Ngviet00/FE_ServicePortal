...
import itFormApi, { HistoryApplicationForm, IRequestStatus } from "@/api/itFormApi";
...
export default function ListITFormWaitFormPurchase() {
    ...
    return (
        <div className="p-1 pl-1 pt-0 space-y-4">
            <div className="flex flex-wrap justify-between items-center gap-y-2 gap-x-4 mb-1">
                <h3 className="font-bold text-xl md:text-2xl m-0 mb-2">{lang == 'vi' ? 'Danh sách đơn IT chờ xác nhận' : 'List form IT wait confirm'}</h3>
            </div>
