    ...
    return (
        <div className="p-1 pl-1 pt-0 space-y-4">
            <div className="flex flex-wrap justify-between items-center gap-y-2 gap-x-4 mb-3">
                ...
                <div>
                    <Button onClick={() => navigate("/resignation")} className="w-full md:w-auto hover:cursor-pointer bg-black text-white hover:bg-black">
                        ...
                        <div className="flex-1 min-w-[150px] relative">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full p-2 border rounded-sm transition duration-150 ease-in-out border-gray-300 text-sm bg-gray-50 ${errors.userName ? 'border-red-500 bg-red-50' : ''}`}
                                />
                            </div>
                        </div>
                        <div className="flex-1 min-w-[150px] relative">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full p-2 border rounded-sm transition duration-150 ease-in-out border-gray-300 text-sm bg-gray-50 ${errors.department ? 'border-red-500 bg-red-50' : ''}`}
                                />
                            </div>
                        </div>
                        <div className="flex-1 min-w-[150px] relative">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full p-2 border rounded-sm transition duration-150 ease-in-out border-gray-300 text-sm  ${errors.position ? 'border-red-500 bg-red-50' : ''}`}
                                />
                            </div>
                        </div>
                        <div className="flex-1 min-w-[150px] relative">
