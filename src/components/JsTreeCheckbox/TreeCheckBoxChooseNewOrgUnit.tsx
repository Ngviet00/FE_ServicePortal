...
export function TreeCheckBoxChooseNewOrgUnit({ data, onChange, loadChildren, defaultCheckedIds, onClickOpenDetailPositionMngLeaveRequest }: PropsTreeCbLeaveRequest) {
